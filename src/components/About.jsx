        ...
        <div className='content_container'>
            <main className="sidebyside_content">
                <div className="img_container">
                    <img src="pending_artwork.jpg" alt="main_page_img" id="img_content"/>
                </div>
                <div className="text_content">
                    ...
                    to enhance control testing through code inspection. Moving on further into audit, I began to miss the excitement 
            ...
            <footer class="footer_container">
                <div class="footer_alignment">
                    ...
                    <p className="footer_content"> 
                        Artwork on this page is done by the lovely *Pending Artist Name*, for my personal use only.
                    </p>
